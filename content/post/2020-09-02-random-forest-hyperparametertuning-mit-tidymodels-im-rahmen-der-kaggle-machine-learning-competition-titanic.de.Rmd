...
Als mögliche Werte für die Anzahl der verwendeten Trees pro Random Forest wurden die Werte 1, 500, 1000, 1500 und 2000 verwendet. 
...
Wir visualisieren die ROC Kurven, wobei wir jeweils die Kurven durch eine der drei Hyperparameter gruppieren und einfärben.
...
final_pred_binary <- ifelse(final_pred$predictions[,2] > 0.5, 1, 0) %>% factor(levels = c(0, 1))
